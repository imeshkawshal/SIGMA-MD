...
global.sudo  =  process.env.SUDO || "94768704257" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '13_07_2024_SIGMA_MD_bA0jar1C_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'sɪɢᴍᴀ-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ɴɪᴋɪʏᴀ`, // ADD YOUR NAME
